                ...
                <div class="box-body">
                    ...
                    <div class="nav-tabs-custom">
                        ...
                        <ul class="nav nav-tabs">
                            ...
                            <li class="active">
                                <a href="#home" data-toggle="tab">资料信息</a>                             
                            </li>                            
                        </ul>
                        <!--tab头/-->
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="home">
                                <div class="row data-type">                                  
                                    ...
                                    <div class="col-md-10 data">
                                        <input type="text" class="form-control"   placeholder="QQ" value="">
                                    </div>
				      ...
				      <button class="btn btn-primary" ><i class="fa fa-save"></i>保存</button>
						  <input type="submit"  data-toggle="modal" class="btn btn-danger" value="提交" />
					  </div>
					</form>		 
                    </div>

...
public class FreemarkerTest {
    ...
    public static void main(String[] args) throws IOException, TemplateException {
        ...
        // 第二步：设置模板文件所在的路径。
        configuration.setDirectoryForTemplateLoading(new File("H:\\working\\workspace\\javaee-dev87\\FreemarkerDemo\\src\\main\\resources"));
        ...
        Writer writer = new FileWriter(new File("h:\\working\\workspace\\javaee-dev87\\FreemarkerDemo\\src\\main\\resources\\test.html"));
